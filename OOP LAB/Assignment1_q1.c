...
void findTotalMarksPercentageStudents(struct Student students[], int
                                                                     numberStudents)
{
    int i, m;
...
// c. Display the details for all the students having percentage in a
given range.void displayDetailsSudentsPercentageRange(struct Student students[], int numberStudents, float percentage1, float percentage2)
{
    int i, m;
    for (i = 0; i < numberStudents; i++)
    {
        if (students[i].percentage >= percentage1 && students[i].percentage <=
                                                         percentage2)
        {
            printf("The student's name: %s\n", students[i].name);
            printf("The student's roll number: %d\n", students[i].rollNumber);
...
void main()
{
    ...
    scanf("%f", &percentage2);
    displayDetailsSudentsPercentageRange(students, numberStudents, percentage1,
                                         percentage2);
